...
A Python application for scanning directories of wallpaper images and storing them in a database with automatic tagging based on folder structure and picking wallpapers based on rules.
I.e. prefer images tagged with "rain" or "rainy" if it's currently raining.
