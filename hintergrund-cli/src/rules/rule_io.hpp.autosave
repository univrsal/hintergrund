...
protected:
    ...
    inline const char* comp_to_str(compare_type c)
    {
        switch (c) {
        case COMP_EQUAL:
            return "==";
...
public:
    ...
    compare_type comp_type() const;
    io_type	target() const;
    const char* str_target() const;
    int int_target() const;

    void set_comp_type(compare_type t);
    void set_target(io_type t);
